...
O sistema foi projetado para funcionar em conjunto com o template $\LaTeX$ [caderno_prova](https://github.com/wyllianbs/carderno_prova), que permite gerar provas formatadas com gabarito.
